...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-20 bg-gradient-to-br from-green-50 to-teal-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-20 left-20 w-24 h-24 bg-gradient-to-br from-green-200 to-teal-200 rounded-lg opacity-20"
        />
        <motion.div
          animate={{
            x: [0, -70, 0],
          ...
          className="absolute bottom-20 right-20 w-32 h-32 border-4 border-teal-200 rounded-full opacity-20"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-green-400 to-teal-500 rounded-full"></div>
              ...
              >
                ...
                <div className={`w-full lg:w-5/12 ${index % 2 === 0 ? 'lg:pr-8' : 'lg:pl-8'}`}>
                  ...
                  >
                    <div className="flex items-center mb-4">
                      <div className="p-2 bg-gradient-to-br from-green-500 to-teal-500 rounded-lg text-white mr-3">
                        {exp.icon}
                      </div>
                      <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.skills.map((skill) => (
                        <span
                          key={skill}
                          className="px-3 py-1 bg-gradient-to-r from-green-100 to-teal-100 text-green-700 text-sm rounded-full font-medium"
                        >
                          {skill}
                        </span>
                      ))}
                ...
                <div className="hidden lg:flex w-2/12 justify-center">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-6 h-6 bg-gradient-to-br from-green-500 to-teal-500 rounded-full border-4 border-white shadow-lg"
                  ></motion.div>
                </div>
